        ...
        <div>
            ...
            <div class="border-b border-blue p-5">
                <div className="flex">
                    ...
                    <button class="text-blue text-xl font-bold rounded-full border-blue border-2 hover:text-white 
                        hover:bg-blue hover:border-transparent font-montserrat py-2 px-6 ml-auto my-2 mr-4">Log In</button>

                    <button class="shadow w-15 block border-blue border-2 rounded-full focus:outline-none focus:border-blue px-3 my-2 mr-3">
