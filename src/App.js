  ...
  return (
    <div className="App">
      ...
      <div class="container flex-row">
        ...
        <button class="text-black text-xs font-montserrat rounded-full border-blue border-2 p-3">
          Search for products... <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 " fill="none" 
